    ...
    return (
        ...
        <div className='bg-gradient-to-r from-indigo-400 ...'>
            <div className='flex items-center justify-between h-16 mx-auto max-w-7xl'>
                <div>
                    <h1 className='text-2xl font-bold'>Job<span className='text-[#F83002]'> Zone</span></h1>
                </div>
                    ...
                    </ul>
                    {
                        !user ? (
                            <div className='flex items-center gap-2'>
                                ...
                                <Link to='/Singup'><Button className="bg-[#6A38C2] hover:bg-[#5b30a6]">Signup</Button></Link>
                            </div>
